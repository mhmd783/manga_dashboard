...
class BodyAllOrdersCampain extends StatelessWidget {
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          return Container(
                            child: ListTile(
                              onTap: () {
                                print(data['data']['campaigns']['$i']
                                    ['employee_id']);
                                val.StoreOneEmployee(data['data']['campaigns']
                                    ['$i']['employee_id']);
                                Navigator.of(context).pushNamed("employee");
                              },
                              title: Text(
                                "(${data['data']['campaigns']['$i']['order_type']})  في حمله علي ",
                                style: TextStyle(color: Colors.black),
                              ),
                              subtitle: Text(
                                "${data['data']['campaigns']['$i']['employee_name']} اسم الموظف ",
                                //"${data['data']['campaigns']['$i']['target']}.....${data['data']['campaigns']['$i']['target_area']}",
